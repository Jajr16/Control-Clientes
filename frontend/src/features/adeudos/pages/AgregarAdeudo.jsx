...
import { getEmpresas } from "../../clientes/api/empresas.js";
import { addAdeudo } from "../api/adeudos.js";
...
const AgregarAdeudo = () => {
    ...
    useEffect(() => {
        const fetchAdeudos = async () => {
            ...
            try {
                const resp = await fetch(`${API_URL}/adeudos/empresa/${empresa.empresa_cif}`);
